...
public class ClientShowAllDoctorsFragment extends Fragment implements ClickInterface {

    public ClientShowAllDoctorsFragment(){
...
//
////                        Fragment Fragment_Doctor_Info = new AdminShowInfoDoctorFragement();
