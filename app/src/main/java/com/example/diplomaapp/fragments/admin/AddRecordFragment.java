...
public class AddRecordFragment extends Fragment {
    ...
    public AddRecordFragment() {
        super(R.layout.fragment_record_add_admin);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        btnRecordDateAdmin = view.findViewById(R.id.btnRecordDateAdmin);
        tvRecordDateAdmin = view.findViewById(R.id.tvRecordDateAdmin);
        spRecordAddAdminDoctor = view.findViewById(R.id.spRecordAddDoctorAdmin);
